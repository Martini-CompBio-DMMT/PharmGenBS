...
#' @param useStoredAll_patients_report reuse stored data
#' @importFrom rmarkdown render
#' @export
#'
create_reports <- function(file_info, file_genos, useStoredAll_patients_report=FALSE) {
  check_local_files()
  sample_info_table <- generate_sample_info_table(file_info, file_genos)
  patients <- sample_info_table$Sample

  if (!file.exists("all_patients_report.RData") || !useStoredAll_patients_report) {
...
#' @export
#'
create_internal_reports <- function(file_info, file_genos, useStoredAll_patients_report=FALSE) {
